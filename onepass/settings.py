...
DEFAULT_FROM_EMAIL = config("DEFAULT_FROM_EMAIL", default="OnePass <noreply@onepass.local>")
...
FIREBASE = {
    ...
    "STORAGE_BUCKET": config("FIREBASE_STORAGE_BUCKET", default=""),
    "MESSAGING_SENDER_ID": config("FIREBASE_MESSAGING_SENDER_ID", default=""),
    "APP_ID": config("FIREBASE_APP_ID", default=""),
    "DATABASE_URL": config("FIREBASE_DATABASE_URL", default=""),
    "SERVICE_ACCOUNT": config("FIREBASE_SERVICE_ACCOUNT", default="serviceAccountKey.json"),
}
